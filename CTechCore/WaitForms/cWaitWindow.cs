...
namespace CTechCore.WaitForms
{
    ...
    public sealed class cWaitWindow
    {
        ...
        public static object Show(EventHandler<WaitWindowEventArgs> workerMethod, string message, params object[] args)
        {
            ...
            return instance.Show(workerMethod, message, font, new System.Drawing.Color(), false, arguments);
        }
        ...
        public bool ProcessFailure 
        {
            set
            {
                this._GUI.Invoke(new MethodInvoker<bool>(this._GUI.SetProcessFailure), value);
            }
        }
        ...
        private object Show(EventHandler<WaitWindowEventArgs> workerMethod, string message, System.Drawing.Font font, System.Drawing.Color forecolor, bool CloseOnComplete, List<object> args)
        {
            this.Font = font;
