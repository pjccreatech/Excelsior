...
namespace CTechCore.Tools
{
    public partial class cntrlSearch : UserControl
    {
        ...
        public delegate void RowEnterKeyPressEvent(object sender, object Row);
        public RowEnterKeyPressEvent OnRowEnterKeyPress { get; set; }
        ...
        {
            get { return pnlFind.Height == 0; }
            set { pnlFind.Height = value.HasValue ? (Convert.ToBoolean(value) ? 40 : 0) : 40; }
        }
        ...
        public object DataSource
        {
            ...
            set
            {
                ...
                if(this.gridView1.Columns.Count > 0)
                    this.gridView1.Columns[0].Visible = this.gridView1.Columns.Count == 1;
        ...
        public void FocusSearchBox() { TextEditor.Focus(); }
        public void FocusGrid() { gridControl1.Focus(); }
        public cntrlSearch()
        {
            InitializeComponent();
            TextEditor.Properties.MaxItemCount = -1;
        ...
        {
            if (e.KeyCode == Keys.Enter) SetEditValue();
            if (e.KeyCode != Keys.Down
                && e.KeyCode != Keys.Up
        ...
        private void gridControl1_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                if (this.OnRowEnterKeyPress != null)
                    this.OnRowEnterKeyPress(this.gridView1, gridView1.GetRow(this.gridView1.FocusedRowHandle));
            }
        }
    }
}
