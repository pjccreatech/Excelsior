...
{
    public partial class frmSalesOrderOLD : CTechCore.Models.Document.frmDocumentBase
    {
        public frmSalesOrderOLD()
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
            ...
            MyApp.CTech.ExecSQL($" SELECT * FROM vw_XR_GetCustomersBasics", ref dt);
        ...
        private void frmSalesOrder_Format(object sender, ConvertEventArgs e)
        {
            ...
            //e.Value += so.Status == HertexCore.Core.Enums.DocumentState.New ? " - New": $": {so.Customer.Name}";
        }
        ...
        private void popupContainerEdit1_QueryDisplayText(object sender, DevExpress.XtraEditors.Controls.QueryDisplayTextEventArgs e)
        {
            ...
            if (e.EditValue.GetType().Equals(typeof(AccountsReceivable.Customers.Customer)))
            {
                AccountsReceivable.Customers.Customer dr = (AccountsReceivable.Customers.Customer)e.EditValue;                
        ...
        private void lkpVAT_CustomDisplayText(object sender, DevExpress.XtraEditors.Controls.CustomDisplayTextEventArgs e)
        {
            ...
            e.DisplayText = ((HertexCore.Library.Models.Company.Tax.TaxRate)e.Value).Code;
        }
        ...
        private void gridControl1_Click(object sender, EventArgs e)
        {
            ...
            SalesOrders.SalesOrder SO = (SalesOrder)SalesOrderBindingSource.DataSource;
            if (popupContainerEdit1.EditValue == null || SO.CustomerID <= 0)
            {
